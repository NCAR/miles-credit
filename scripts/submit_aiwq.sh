#!/bin/bash -l
#PBS -N AIWQ
#PBS -l select=1:ngpus=1:gpu_type=a100_80gb:mem=128GB:ncpus=16
...
torchrun realtime_wrapper_SDL.py \
      -d "$DATE_FLAG" \
      -c /glade/work/cbecker/miles-credit/config/aiwq_SDL.yaml
