...
print(sample["ERA5_LowerAir"].keys())
print(sample["ERA5_LowerAir"]["input"].keys())
print(sample["ERA5_LowerAir"]["target"].keys())
print(sample["ERA5_LowerAir"]["metadata"])

print(sample["ERA5_UpperAir"].keys())
print(sample["ERA5_UpperAir"]["input"].keys())
print(sample["ERA5_UpperAir"]["target"].keys())
print(sample["ERA5_UpperAir"]["metadata"])
...
print(sample["GOES"].keys())
print(sample["GOES"]["input"].keys())
print(sample["GOES"]["target"].keys())
print(sample["GOES"]["metadata"])
