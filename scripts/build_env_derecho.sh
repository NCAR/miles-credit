...
TARGET_ENV=/glade/work/$USER/conda-envs/credit-main-derecho
...
# Upgrade pip/setuptools first — cloned envs may have versions that
# cannot parse pyproject.toml license = {text = "..."} correctly
