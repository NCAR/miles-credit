...
class TestDataMapRegression:
    ...
    def test_cross_file_sample_retrieval_integration(self):
        ...
        datamap = DataMap(
            ...
            glob="data_*.nc",
            variables={"boundary": ["boundary_field"], "prognostic": ["prognostic_field"], "diagnostic": ["diagnostic_field"]},
            history_len=2,
            forecast_len=1,
        )
    ...
    def test_file_indexing_math_regression(self):
        ...
        datamap = DataMap(rootpath=self.temp_dir, glob="data_*.nc", variables={"boundary": ["boundary_field"]}, history_len=2, forecast_len=1)
