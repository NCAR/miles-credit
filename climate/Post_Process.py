...
def post_process(conf, avg_window, variables, name_string="", reset_times=True, dask_do=False, monthly=False, rescale_it=False, n_processes=None, save_append=None):
    """
    ...
    if avg_window:
        ...
        date_range = pd.date_range(start=f"{start_year}-{start_month:02d}", end=f"{end_year}-{end_month:02d}", freq="MS")  # 'MS' is Month Start
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reset_times", type=str2bool, nargs="?", const=True, default=False, help="Reset time coordinates. Use 'True' or 'False'. Default is False.")
    parser.add_argument("--dask_do", type=str2bool, nargs="?", const=True, default=False, help="Enable dask parallel processing. Use 'True' or 'False'. Default is False.")
    parser.add_argument("--rescale_it", type=str2bool, nargs="?", const=True, default=False, help="Enable dask parallel processing. Use 'True' or 'False'. Default is False.")
