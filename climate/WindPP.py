...
def simple_wind_artifact_filter(u_wind, v_wind, speed_threshold=25.0, smooth_sigma=2.0, dilation_zonal=9, dilation_meridional=3, falloff_sigma=3.0):
    """
    ...
    smooth_blend_mask = F.conv2d(expanded_mask_float, gaussian_2d_falloff, padding=(falloff_kernel_size_lat // 2, falloff_kernel_size_lon // 2))
