...
trainer_types = {
    ...
    "goes10km-distributed-ensemble": (
        TrainerGOES10km,
        "loading a distributed CRPS trainer for GOES 10km dataset",
    ),  # NOTE: load same trainer, distributed config happens in trainer init
}
