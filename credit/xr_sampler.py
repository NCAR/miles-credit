...
class XRSamplerByYear:
    ...
    def __init__(self, config_path, conf=None):
        ...
        save_keywords = ["save_loc", "save_loc_surface", "save_loc_dynamic_forcing", "save_loc_diagnostic", "save_loc_forcing"]
        ...
        self.variables = []
        for data_kw in ["variables", "surface_variables", "dynamic_forcing_variables", "diagnostic_variables", "forcing_variables"]:
