...
class PostBlock(nn.Module):
    def __init__(self, post_conf):
        ...
        if post_conf["global_drymass_fixer"]["activate"]:
            if post_conf["global_drymass_fixer"]["activate_outside_model"] is False:
                logger.info("GlobalDryMassFixer registered")
                opt = GlobalDryMassFixer(post_conf)
                self.operations.append(opt)
...
class GlobalMassFixer(nn.Module):
    ...
    def forward(self, x):
        ...
        #print('q_correct_ratio:', q_correct_ratio)
...
class GlobalDryMassFixer(nn.Module):
    '''
...
class GlobalWaterFixer(nn.Module):
    ...
    def __init__(self, post_conf):
        ...
        if post_conf['global_water_fixer']['simple_demo']:
            ...
            if post_conf['global_mass_fixer']['grid_type'] == 'sigma':
                ...
                print('!!!!!!!! coef A !!!!!!!! :', self.coef_a)
                print('!!!!!!!! coef B !!!!!!!! :', self.coef_b)
    ...
    def forward(self, x):
        ...
        #print('residual water: ', residual)
        #print('Precip SUM: ', P_sum)
        #print('EVAP SUM: ', E_sum)
        #print('TWC sum:' , TWC_sum)

        # print('resid: ', residual)
        # print('PSUM: ', P_sum)
        # print('ESUM: ', E_sum)
        # print('TWC_sum', TWC_sum)
        
        # compute correction ratio
        P_correct_ratio = (P_sum + residual) / P_sum
        #print('P_correct_ratio: ', P_correct_ratio)
