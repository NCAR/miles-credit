...
# FINAL_IC_DIR = f"/glade/derecho/scratch/kjmayer/CREDIT_runs/AIWQ_inits/{DATE}/"
FINAL_IC_DIR = f'/glade/derecho/scratch/cbecker/CREDIT_runs_realtime/AIWQ_inits/{pd.Timestamp(args.date).strftime("%Y%m%d")}/'
# -----------------------------------------------------------------
...
for GEFSmbr in GEFSmbrs:
    ...
    # original_file = f"/glade/derecho/scratch/kjmayer/CREDIT_runs/AIWQ_init/"+pd.Timestamp(args.date).strftime("%Y%m%d")+f'/gefs_cam_grid_{GEFSmbr}.nc'
    original_file = '/glade/derecho/scratch/cbecker/CREDIT_runs_realtime/AIWQ_inits/'+pd.Timestamp(args.date).strftime("%Y%m%d")+f'/gefs_cam_grid_{GEFSmbr}.nc'
